    ...
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-8">
        <div class="w-full max-w-md bg-white p-10 rounded-xl shadow-2xl border border-gray-100 form-card">
            ...
            <div class="mt-10 pt-6 border-t border-gray-100 text-center">
                ...
                <a href="{{ url('/signup') }}" class="mt-4 inline-block px-8 py-2 border-2 border-primary text-primary font-bold rounded-md hover:bg-primary hover:text-white transition duration-300 transform hover:scale-105">
                    GO TO SIGN UP
                </a>
            </div>
        </div>
