...
<body class="flex h-screen overflow-hidden font-sans bg-[#b5eeff]">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        <div
            class="w-full max-w-xl bg-white p-10 rounded-xl shadow-2xl border border-gray-100 agreement-card overflow-y-auto max-h-[90vh]">
            ...
            <p class="text-gray-600 text-sm mb-6">
                ...
                Before proceeding please read thoroughly the following terms and conditions. By clicking "Continue", you
                acknowledge that you have read, understood, and agree to be bound by this User Agreement. If you do not
                agree to these terms, please do not use the CLMS Portal.
            </p>

            <p class="text-gray-600 text-sm mb-4">
                CLMS automatically records your personal information as the last user during your session. By this, we
                will identify who's gonna be the responsible for any damages, missing parts, or issues before you log
                out. This agreement outlines your responsibilities and the rules you must follow while using the CLMS
                Portal and its associated computer laboratories.
            </p>
            ...
            <div class="space-y-4 text-sm text-gray-700">
                ...
                <div>
                    ...
                    <p>
                        As the last user, you are fully responsible for any damages, loss, or any issues during your
                        time. And you should log out completely when finished.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                        Any damage — scratched keyboards, cracked screens, etc. found after your time will be traced to
                        you as the last user.
                ...
                <div>
                    ...
                    <p>
                        We collect only your name, timestamps, and user's computer number for accountability purposes,
                        in full compliance with Republic Act No. 10173 (Data Privacy Act of 2012).
                        Data is confidential and only the lab admin has authorized for monitoring, used only for
                        maintenance, tracing, and deleted after 30 days.
            ...
            <div class="mt-6 text-center">
                <a href="{{ url('/login') }}" class="text-primary font-semibold hover:underline text-sm">
                    Back to Login
                </a>
            </div>
